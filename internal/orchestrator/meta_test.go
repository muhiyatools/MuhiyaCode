...
func TestSystemPromptBudgetAndStability(t *testing.T) {
	ctx := PromptContext{Workspace: `F:\work`, OS: "Windows", Shell: "pwsh", Date: "2026-07-10", Model: "deepseek-v4-pro", ModelAddendum: "", HasSubagents: true, SubagentModel: "deepseek-v4-flash"}
...
func TestPrefixStableAcrossTurnsAndClasses(t *testing.T) {
	system := SystemPrompt(PromptContext{Workspace: `F:\work`, OS: "windows", Shell: "pwsh", Date: "2026-07-11", Model: "deepseek-v4-pro", HasSubagents: true, SubagentModel: "deepseek-v4-flash"})
	h := NewHistory(HistorySnapshot{Version: 1}, nil)
