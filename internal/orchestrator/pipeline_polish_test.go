...
// TestDecodeToolArgsRepairsRegexEscapes locks in the live update_plan fix: a
// model writing regex/paths verbatim into JSON string args ("\s", "\d") no
// longer hard-fails the tool call; valid JSON passes through untouched.
